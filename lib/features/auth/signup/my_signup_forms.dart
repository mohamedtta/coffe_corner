...
class MySignUpForms extends StatelessWidget {
  const MySignUpForms({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 15,),
          const Text('Re-Enter your password' , style: TextStyle(fontSize: 16 , fontWeight: FontWeight.w600),),
          MyForm(txt: "Enter your password",),
